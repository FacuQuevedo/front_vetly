        ...
        <div className="collapse-content">
          ...
          <div className="grid grid-cols-1 gap-12">
            <div className="p-4">
              ...
              <button>Como cuidamos tu privacidad</button>{" "}
              <button>Accesibilidad</button>{" "}
              <button>Informaicon al usuario financiero </button>{" "}
              <button>Ayuda</button> <button>Defensa del Consumidor</button>{" "}
              <button>Informacion sobre seguros</button>
              <br />
